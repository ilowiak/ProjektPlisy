...
CREATE TABLE IF NOT EXISTS `mydb`.`Wycena` (
  ...
  `Konfigurator_id` INT NOT NULL,
  `Konfigurator_Kolor_id` INT NOT NULL,
  `Konfigurator_Model_id` INT NOT NULL,
  `Konfigurator_Typy_montazu_id` INT NOT NULL,
  `Konfigurator_Materialy_id` INT NOT NULL,
  `Konfigurator_Produkt_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_Wycena_Konfigurator1_idx` (`Konfigurator_id` ASC, `Konfigurator_Kolor_id` ASC, `Konfigurator_Model_id` ASC, `Konfigurator_Typy_montazu_id` ASC, `Konfigurator_Materialy_id` ASC, `Konfigurator_Produkt_id` ASC),
  CONSTRAINT `fk_Wycena_Konfigurator1`
    FOREIGN KEY (`Konfigurator_id` , `Konfigurator_Kolor_id` , `Konfigurator_Model_id` , `Konfigurator_Typy_montazu_id` , `Konfigurator_Materialy_id` , `Konfigurator_Produkt_id`)
    REFERENCES `mydb`.`Konfigurator` (`id` , `Kolor_id` , `Model_id` , `Typy_montazu_id` , `Materialy_id` , `Produkt_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`Produkt` (`id`, `nazwa`, `szer`, `wys`, `cenabazowa`, `idnazwa`) VALUES (1, 'Żaluzja Plisowana', 50, 70, 50.00, '1');
INSERT INTO `mydb`.`Produkt` (`id`, `nazwa`, `szer`, `wys`, `cenabazowa`, `idnazwa`) VALUES (2, 'Żaluzja Plisowana', 50, 90, 70.00, '1');
INSERT INTO `mydb`.`Produkt` (`id`, `nazwa`, `szer`, `wys`, `cenabazowa`, `idnazwa`) VALUES (3, 'Żaluzja Plisowana', 50, 110, 90.00, '1');
INSERT INTO `mydb`.`Produkt` (`id`, `nazwa`, `szer`, `wys`, `cenabazowa`, `idnazwa`) VALUES (4, 'Żaluzja Plisowana', 50, 130, 110.00, '1');
INSERT INTO `mydb`.`Produkt` (`id`, `nazwa`, `szer`, `wys`, `cenabazowa`, `idnazwa`) VALUES (5, 'Żaluzja Plisowana', 50, 150, 130.00, '1');
INSERT INTO `mydb`.`Produkt` (`id`, `nazwa`, `szer`, `wys`, `cenabazowa`, `idnazwa`) VALUES (6, 'Żaluzja Plisowana', 70, 90, 80.00, '1');
INSERT INTO `mydb`.`Produkt` (`id`, `nazwa`, `szer`, `wys`, `cenabazowa`, `idnazwa`) VALUES (7, 'Żaluzja Plisowana', 70, 110, 100.00, '1');
INSERT INTO `mydb`.`Produkt` (`id`, `nazwa`, `szer`, `wys`, `cenabazowa`, `idnazwa`) VALUES (8, 'Żaluzja plisowana', 70, 130, 120.00, '1');
INSERT INTO `mydb`.`Produkt` (`id`, `nazwa`, `szer`, `wys`, `cenabazowa`, `idnazwa`) VALUES (9, 'Żaluzja Plisowana', 70, 150, 140.00, '1');
INSERT INTO `mydb`.`Produkt` (`id`, `nazwa`, `szer`, `wys`, `cenabazowa`, `idnazwa`) VALUES (10, 'Żaluzja Plisowana', 80, 100, 90.00, '1');
INSERT INTO `mydb`.`Produkt` (`id`, `nazwa`, `szer`, `wys`, `cenabazowa`, `idnazwa`) VALUES (11, 'Żaluzja Plisowana', 80, 120, 110.00, '1');
INSERT INTO `mydb`.`Produkt` (`id`, `nazwa`, `szer`, `wys`, `cenabazowa`, `idnazwa`) VALUES (12, 'Żaluzja Plisowana', 80, 140, 130.00, '1');
INSERT INTO `mydb`.`Produkt` (`id`, `nazwa`, `szer`, `wys`, `cenabazowa`, `idnazwa`) VALUES (13, 'Żaluzja plisowana', 80, 160, 150.00, '1');
INSERT INTO `mydb`.`Produkt` (`id`, `nazwa`, `szer`, `wys`, `cenabazowa`, `idnazwa`) VALUES (14, 'Żaluzja Plisowana', 80, 180, 170.00, '1');
INSERT INTO `mydb`.`Produkt` (`id`, `nazwa`, `szer`, `wys`, `cenabazowa`, `idnazwa`) VALUES (15, 'Żaluzja Plisowana', 80, 200, 190.00, '1');
INSERT INTO `mydb`.`Produkt` (`id`, `nazwa`, `szer`, `wys`, `cenabazowa`, `idnazwa`) VALUES (16, 'Żaluzja Plisowana', 80, 220, 210.00, '1');
